                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <a href="{{ route('orders.index') }}?status=delivered" class="btn btn-primary btn-sm">View
                                    All</a>
                            </div>
                            <ul class="nav nav-tabs card-header-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="this-month-tab" data-bs-toggle="tab" href="#this-month"
                                        role="tab">This Month</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="last-month-tab" data-bs-toggle="tab" href="#last-month"
                                            ...
                                            <tbody>
                                                @forelse($thisMonthDelivered as $order)
                                                    <tr>
                                                        <td>
                                                            <a
                                                                href="{{ route('orders.show', $order) }}">{{ $order->order_no }}</a>
                                                            @if ($order->note)
                                                                <br/>
                                                                <span class="badge bg-secondary">{{ $order->note }}</span>
                                                            @endif
                                                        </td>
                                                        <td>{{ $order->customer->name }}</td>
                                                        <td>{{ $order->order_date ? Carbon\Carbon::parse($order->order_date)->format('d/m/Y') : '-' }}
                                                        </td>
                                                        <td>{{ $order->container_no }}</td>
                                                    </tr>
                                                @empty
                                                    <tr>
                                                        <td colspan="4" class="text-center">No orders completed this month
                                                        </td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="4" class="text-center">No orders completed last month
                                                        </td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                    ...
                                    <tbody>
                                        @forelse($upcomingOrders as $order)
                                            <tr>
                                                ...
                                                <td>{{ $order->customer->name }}</td>
                                                <td>{{ $order->target_date ? Carbon\Carbon::parse($order->target_date)->format('d/m/Y') : '-' }}
                                                </td>
                                                <td>
